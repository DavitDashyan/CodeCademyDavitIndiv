 ...
 * This method tests if a given grade is within the valid range of 1 to 10,
 * inclusive.
 */
public class IsValidGradeTest {
    ...
    public void testIsValidGrade_ValidMinimum() {
        System.out.println("isValidGrade");
    ...
    /**
     * Test to verify that a grade just below the valid range (0) is recognized as
     * invalid.
     */
    @Test
    ...
    /**
     * Test to verify that a grade just above the valid range (11) is recognized as
     * invalid.
     */
    @Test
    ...
    /**
     * Test to verify that a grade well within the valid range (e.g., 5) is
     * recognized as valid.
     */
    @Test
